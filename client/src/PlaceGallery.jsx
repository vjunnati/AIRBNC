...
export default function PlaceGallery({place}) {
        ...
        return (
            <div className="absolute inset-0 bg-black min-h-max">
                <div className="p-8 grid gap-4 ">
                    <div>
                        <button onClick={() => setShowAllPhotos(false)} className="fixed right-12 top-8 flex gap-1 py-1 px-1 rounded-full bg-white shadow shadow-black">
    ...
    return(
        <div className="relative">
                ...
                <button onClick={() => setShowAllPhotos(true)} className="flex gap-1 items-center absolute bottom-2 right-2 py-2 px-3 bg-white rounded-2xl shadow-md shadow-gray-500">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
